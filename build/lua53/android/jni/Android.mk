...
# build/lua53/android/jni/
LOCAL_TO_PROJECT = ../../../..

LOCAL_C_INCLUDES := $(LOCAL_PATH)/$(LOCAL_TO_PROJECT)/3rd/lua53/src
LOCAL_C_INCLUDES += $(LOCAL_PATH)/$(LOCAL_TO_PROJECT)/3rd/lua-protobuf
...
LOCAL_SRC_FILES :=  $(LOCAL_TO_PROJECT)/src/tolua.c \
                    ...
                    $(LOCAL_TO_PROJECT)/3rd/lua-protobuf/pb.c \
